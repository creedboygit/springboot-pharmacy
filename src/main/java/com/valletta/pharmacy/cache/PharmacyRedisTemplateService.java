package com.valletta.pharmacy.cache;
...
public class PharmacyRedisTemplateService {
    ...
    public void save(PharmacyDto pharmacyDto) {
        ...
        try {
            hashOperations.put(CACHE_KEY,
                ...
                serilizePharmacyDto(pharmacyDto));
    ...
    private String serilizePharmacyDto(PharmacyDto pharmacyDto) throws JsonProcessingException {
